...
<ul>
  ...
  <li><a class="active" href="candidate_account.php">Account Details</a></li>
  <li><a href="candidate_results.php">Results</a></li>
  <li><a href="#news">News</a></li>
  <li><a href="#contact">Contact</a></li>
  <li><a href="#about">About</a></font></li>
 

</ul>
 
<div style="margin-left:-15%;padding:8% 300px;height:auto; background-image:url('https://www.gannett-cdn.com/presto/2019/03/20/PBIN/e9dfb24f-3532-4245-bb5e-a3b9665583fe-GettyImages-884243522.jpg?crop=4999,2835,x0,y559&width=3200&height=1680&fit=bounds'); background-size:1750px 800px;  background-repeat:no-repeat,no-repeat;background-attachment: fixed ;">
   ...
   <?php $candi_username=$_SESSION['candi_username'];?>
			...
			?>	
				...
				<?php while ($row = mysqli_fetch_array($results)) { ?>
					<label>	<b>CANDIDATE NAME :</b><i><?php echo $row['candi_name']; ?></i></label><br>
					<label>	<b>CANDIDATE PHOTO :</b><i><?php echo $row['candi_photo']; ?></i></label><br>
					<label>	<b>CANDIDATE SYMBOL :</b><i><?php echo $row['candi_symbol']; ?></i></label><br>
					<label>	<b>VOTER AADHHAR CARD :</b><i><?php echo $row['aadhar_id']; ?></i></label><br>
					<label>	<b>VOTER ID :</b><i><?php echo $row['voter_id']; ?></i></label><br>
					<label>	<b>CANDIDATE ID :</b><i><?php echo $row['candi_id']; ?></i></label><br>
					...
					<label><b>	CONTEST VILLAGE NAME :</b><i><?php echo $row['contest_villa']; ?></i></label><br>
			...
			<center><button class="button" name="button" type="button" onclick="location.href='candidate_account_edit.php'">EDIT YOUR DETAILS</button><br></center><br>
