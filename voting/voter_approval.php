...
<ul>
 <li><font face = "Times New Roman" size = "4"><a  href="ec_home.php">welcome</a></li>
  <li><a class="active" href="voter_approval.php">Voter Approval</a></li>
...
<div style="margin-left:-15%;padding:8% 300px;height:100%;width:125%; background-image:url('https://www.gannett-cdn.com/presto/2019/03/20/PBIN/e9dfb24f-3532-4245-bb5e-a3b9665583fe-GettyImages-884243522.jpg?crop=4999,2835,x0,y559&width=3200&height=1680&fit=bounds'); background-size:1750px 800px;  background-repeat:no-repeat,no-repeat;background-attachment: fixed ;">
  <form action="voter_approval.php" method="post">
  <?php $ec_username=$_SESSION['ec_username'];?>
			...
			<?php 
				$results = mysqli_query($con, "SELECT * FROM voter where apporval_status='pending' or apporval_status='reject' ");
			?>	
			...
			<table border="0%">
				<thead style="color:white" >
					<tr><b>
						...
						<th>VOTER ADDRESS</th>
						<th>VOTER APPROVAL STATUS</th>
						<th>RECOGNIZE THE VOTER</th>
						<th>REJECT THE VOTER</th>
						</b>
					</tr>
				</thead>
...
<?php
			if(isset($_POST['vote']))
			{
				...
				$query1=" INSERT INTO voter_approval_log (voter_id,ec_id,date) VALUES ('$voterid','$ec_id','$date') ;";
						$query_run1=mysqli_query($con,$query1);
						if($query_run1)
						{  
							$query2="update voter set apporval_status='$vote' where voter_id='$voterid';";
							...
							if($query_run2)
								{ 
									...
									echo "<script> window.location.href='voter_approval.php';</script>"; exit;
								}
							else
								{
