...
<ul>
  ...
  <div class="dropdown">
        ...
        <div class="dropdown-content">
   			  <a href="candidate_register.php">Register</a>
...
<div style="margin-left:-15%;padding:8% 300px; height:515px; background-image:url('https://www.gannett-cdn.com/presto/2019/03/20/PBIN/e9dfb24f-3532-4245-bb5e-a3b9665583fe-GettyImages-884243522.jpg?crop=4999,2835,x0,y559&width=3200&height=1680&fit=bounds'); background-size:1750px 800px;  background-repeat:no-repeat,no-repeat;background-attachment: fixed ;">
  <form action="signup1.php" method="post">
			 ...
			 <div class="inner_container">
				<center>
			<h1 style="font-size:30px font-family:Algerian";>WELCOME  CANDIDATE</h1>
			</center>
			<center>
			<br><br>
				<button class="button" name="button" type="button" onclick="location.href='candidate_login.php'">LOGIN</button>
				<button class="button" name="button" type="button" onclick="location.href='candidate_register.php'">REGISTER AS CANDIDATE</button><br><br>
