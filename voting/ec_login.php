...
<ul>
  <li><font face = "Times New Roman" size = "4"><a     href="ec_page.php">Home</a></li>
  <li><a  class="active" href="ec_login.php">Login</a></li>
  <li><a href="#news">News</a></li>
  <li><a href="#contact">Contact</a></li>
  <li><a href="#about">About</a></li></font>
</ul>
  ...
  <form action="ec_login.php" method="post">
	<br><br><br><br><br>
		<div class="inner_container">
			...
			<br>
				<center>Doesn't have an account click here <a href="candidate_register.php"><font size="3px" color="khaki">SIGN UP</font></a><br><br></center>
			<CENTER>	<a href="ec_page.php"><font size="3px" color="khaki">GO BACK</font></a></CENTER><br><br>
			</div>
			...
			if(isset($_POST['submit']))
				{ 
					...
					$password=$_POST['password'];
						$query = "select * from ec_details where username='$ec_username' and password='$password'";
						$query_run= mysqli_query($con,$query) or die( mysqli_error($con));
						if($query_run)
						{
							if(mysqli_num_rows($query_run)>0)
							{
								$_SESSION['ec_username'] = $ec_username;
