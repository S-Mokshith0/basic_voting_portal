...
<div style="margin-left:-15%;margin-top:0%;padding:8% 300px;height:525px; background-image:url('https://www.gannett-cdn.com/presto/2019/03/20/PBIN/e9dfb24f-3532-4245-bb5e-a3b9665583fe-GettyImages-884243522.jpg?crop=4999,2835,x0,y559&width=3200&height=1680&fit=bounds'); background-size:1750px 800px; background-repeat:no-repeat,no-repeat;background-attachment: fixed;">
  <form action="candidate_register.php" method="post">
			...
			<input name="candi_username"type="text" class="inputvalues1"  required /><br><br>
			<label style="color:white"><b>PASSWORD:</b></label><br>
			<input name="candi_password"type="password" class="inputvalues1"  required /><br><br>
	...
	<?php
			...
			{  
				...
				$candi_username=$_POST['candi_username'];
				$candi_password=$_POST['candi_password'];
				$candi_cpassword=$_POST['cpassword'];
				if($password==$cpassword)
				{
					...
					else
					{
						...
						$_SESSION['candi_password'] = $candi_password;
						echo "<script> window.location.href='candidate_register1.php';</script>"; exit;
