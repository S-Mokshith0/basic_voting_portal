...
<ul>
  ...
  <li><a  class="active" href="candidate_login.php">Login</a></li>
  ...
  <form action="candidate_login.php" method="post">
	<br><br><br><br><br>
		<div class="inner_container">
			...
			<CENTER>	<a href="candidatepage.php"><font size="3px" color="khaki">GO BACK</font></a></CENTER><br><br>
			</div>
		...
		<?php
			...
			if(isset($_POST['submit']))
				{ 
					$candi_username=$_POST['username'];
					$password=$_POST['password'];
						$query = "select * from candidate where username='$candi_username' and password='$password' and apporval_status='approve'";
						$query_run= mysqli_query($con,$query) or die( mysqli_error($con));
						if($query_run)
						{
							if(mysqli_num_rows($query_run)>0)
							{
								$_SESSION['candi_username'] = $candi_username;
