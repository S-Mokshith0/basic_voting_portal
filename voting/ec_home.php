...
<ul>
  <li><font face = "Times New Roman" size = "4"><a class="active" href="ec_home.php">welcome</a></li>
  ...
  <?php $ec_username=$_SESSION['ec_username'];?>
	<br><br><br><br><br>
		<div class="inner_container">
			 <center>  
				<h1 style="color:white;"><i>WELCOME  <u><?php echo "$ec_username"?></u></i></h1><br>
				<button class="button" name="button" type="button" onclick="location.href='ec_page.php'">LOGOUT</button>
			</center>
